...
function AnalysisRequestForm(props) {
                ...
                <form onSubmit={handleSubmit(submitHandler)}>
                    ...
                    <div className="flex flex-col mb-3">
                                ...
                                fields.map((field, index) => (
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <button className="bg-red-400 px-3 py-2 rounded-md w-1/4 text-white md:hidden"
                                                    onClick={() => remove(index)}>
                                                Убрать
                                            </button>
                                        </div>
                        ...
                        <button
                            ...
                            onClick={() => append({ objType: "", objId: "" })}>Добавить объект</button>
                    </div>
                    <div className="flex md:flex-row flex-col md:space-x-3 md:space-y-0 space-y-3">
                        ...
                        <button className="px-3 py-2 bg-red-400 text-white hover:bg-red-600 rounded-md">Отменить</button>
                    </div>
